...
function ArmyContainer({ army, onDelete, onDischarge}) {
  ...
  return (
    <div className="h-full overflow-scroll w-5/12 bg-lime-300 p-6">
      <h2 className="text-3xl text-teal-800 text-center mt-2">{army.length<6 ? 
        " Choose a team of six members from the bot collection, each from one of the six classes!!" : "Hurray 🎉🎉🎉 you are ready for the battle!!"}
      </h2>
